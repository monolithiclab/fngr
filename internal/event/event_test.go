...
// goes through. The commit path is exercised by most of this file already;
// what needs naming directly is the wrapping, since the reason inTx exists is
// that two hand-written brackets returned tx.Commit() bare.
